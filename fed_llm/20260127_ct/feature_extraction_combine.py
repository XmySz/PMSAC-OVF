...
if __name__ == '__main__':
    # RANDOM_SEED = 41
    data_total_path=r"/mnt/yxyxlab/qyj/Orthopedics/0115"
    model_total_path = \
    r"/mnt/yxyxlab/qyj/Orthopedics/llm_FL/model_save/0624/dinov2_2025-06-24_llm_fedlwt_resnet18_Orthopedics_1234/models_auc_ratio/llm_fedlwt"
    model_time = "experiment_log-2025-06-24-1208-22.pth"
    #model_time = ".pth"
    epochs = 3
    
    save_path = r"/mnt/yxyxlab/qyj/Orthopedics/0115/fe_combine_result"
    ...
    for epoch in range(epochs, epochs+1):
        ...
        for data_name in data_source:
            ...
            test_file =  "all_centers_test.txt"
            ...
            sio.savemat(feature_save_path, {
                "test_data": train_epoch_Conv_feature_collector,
