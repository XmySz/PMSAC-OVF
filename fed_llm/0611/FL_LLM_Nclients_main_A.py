...
DATA_DIR = r"/mnt/yxyxlab/qyj/Orthopedics/llm_FL/fl_data/0624data/已划分73_new/12"
save_roof = r"/mnt/yxyxlab/qyj/Orthopedics/llm_FL/model_save/0624/%s_%s_%s_%s_%s_12" % (LLM_model, datetime.date.today(), fed_structure, model, dataset)
