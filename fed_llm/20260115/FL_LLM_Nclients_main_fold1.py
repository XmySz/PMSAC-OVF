...
DATA_DIR = r"/mnt/yxyxlab/qyj/Orthopedics/0115/perfold/fold1"
save_roof = r"/mnt/yxyxlab/qyj/Orthopedics/llm_FL/model_save/20260120/fold1/%s_%s_%s_%s_%s_12" % (LLM_model, datetime.date.today(), fed_structure, model, dataset)
