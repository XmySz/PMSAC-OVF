...
if __name__ == '__main__':
    # RANDOM_SEED = 41
    data_total_path=r"/mnt/yxyxlab/qyj/Orthopedics/llm_FL/fl_data/按肌肉类比/已划分73/2"
    model_total_path = \
    r"/mnt/yxyxlab/qyj/Orthopedics/llm_FL/model_save/B/dinov2_2025-06-12_llm_fedlwt_resnet18_Orthopedics_2/models_auc_ratio/llm_fedlwt"
    model_time = "experiment_log-2025-06-12-0835-31.pth"
    #model_time = ".pth"
    epochs = 10
    save_path = r"/mnt/yxyxlab/qyj/Orthopedics/llm_FL/feature_extraction/ts/2"
    ...
    for epoch in range(epochs, epochs+1):
        ...
        data_source=[ "CenterC(bs)", "CenterD(gz)"]
