...
from N_data_dataloaders import recorded_multicenters_data_API_dataloader,recorded_llm_multicenters_dataloader
...
DATA_DIR = r"E:\medical imaging\fed_llm\Endometrial_Cancer_增强_50_0.50"
save_roof = r"E:\medical imaging\fed_llm\model_save\%s_%s_%s_%s_%s_50_0.50" % (LLM_model, datetime.date.today(), fed_structure, model, dataset)
weights_path = r"E:\medical imaging\fed_llm\fed_llm\l2t_ww\resnet18-5c106cde.pth"
