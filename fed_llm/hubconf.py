...
def _make_dinov2_model(
    ...
    **kwargs,
    ...
    if pretrained:
        ...
        model_path = ospj("/mnt/yxyxlab/qyj/Orthopedics/llm_FL/fed_llm" ,f"{model_name}_pretrain.pth")
        
        print(f"[DEBUG] Trying to load model from: {os.path.abspath(model_path)}")
